...
//
// Solidity: function initialize(address marketplaceAddress) returns()
func (_Abinft *AbinftTransactor) Initialize(opts *bind.TransactOpts, marketplaceAddress common.Address) (*types.Transaction, error) {
	return _Abinft.contract.Transact(opts, "initialize", marketplaceAddress)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address marketplaceAddress) returns()
func (_Abinft *AbinftSession) Initialize(marketplaceAddress common.Address) (*types.Transaction, error) {
	return _Abinft.Contract.Initialize(&_Abinft.TransactOpts, marketplaceAddress)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address marketplaceAddress) returns()
func (_Abinft *AbinftTransactorSession) Initialize(marketplaceAddress common.Address) (*types.Transaction, error) {
	return _Abinft.Contract.Initialize(&_Abinft.TransactOpts, marketplaceAddress)
}
