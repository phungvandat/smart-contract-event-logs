...
func (_Abimarket *AbimarketTransactor) Initialize(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Abimarket.contract.Transact(opts, "initialize")
}

// Initialize is a paid mutator transaction binding the contract method 0x8129fc1c.
//
// Solidity: function initialize() returns()
func (_Abimarket *AbimarketSession) Initialize() (*types.Transaction, error) {
	return _Abimarket.Contract.Initialize(&_Abimarket.TransactOpts)
}

// Initialize is a paid mutator transaction binding the contract method 0x8129fc1c.
//
// Solidity: function initialize() returns()
func (_Abimarket *AbimarketTransactorSession) Initialize() (*types.Transaction, error) {
	return _Abimarket.Contract.Initialize(&_Abimarket.TransactOpts)
}
